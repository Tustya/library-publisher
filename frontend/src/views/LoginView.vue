...
const canSubmit = computed(
  () => phoneComplete.value && password.value.length >= 8 && !loading.value
)
    ...
    const msg =
      err && typeof err === 'object' && 'response' in err
        ? (err as { response?: { data?: { detail?: string } } }).response?.data
            ?.detail
        : null
    errorMessage.value = typeof msg === 'string' ? msg : 'Ошибка входа. Проверьте номер и пароль.'
  } finally {
    loading.value = false
  }
}
      ...
      <div class="auth-page__card">
        ...
        >
          <div class="auth-page__field">
            <label for="login-phone" class="auth-page__label">
              Телефон
            </label>
            <PhoneInput
              id="login-phone"
          ...
          <div class="auth-page__field">
            <label for="login-password" class="auth-page__label">
              Пароль
            </label>
